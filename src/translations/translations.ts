...
export const translations = {
  es: {
    ...
    skills: "Skills",
    contact: "Contacto",
    h: "Hola, soy Facundo Tateossian, un desarrollador front-end con ganas de crear nuevas paginas. Mi objetivo es transformar ideas en realidad a través de código limpio y eficiente. ",
    ...
    laboralexpirence: 'Experiencia laboral',
    experiencedes: 'Actualmente no cuento con experiencia laboral formal, pero estoy ansioso por aplicar mis habilidades y conocimientos en proyectos reales para seguir creciendo como desarrollador front-end.',
    name: 'Nombre',
    text: 'Mensaje',
    send: 'Enviar',
  ...
  en: {
    ...
    skills: "Skills",
    contact: "Contact",
    h: "Hi, I'm Facundo Tateossian, a front-end developer eager to create new pages. My goal is to transform ideas into reality through clean and efficient code.",
    ...
    laboralexpirence: 'Laboral experience',
    experiencedes: 'I currently do not have formal work experience, but I am eager to apply my skills and knowledge in real projects to continue growing as a front-end developer.',
    name: 'Name',
    text: 'Menssage',
    send: 'Send',
